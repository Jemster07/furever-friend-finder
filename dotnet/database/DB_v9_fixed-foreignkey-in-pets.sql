...
GO
/****** Object:  Database [final_capstone]    Script Date: 8/13/2023 1:32:04 PM ******/
...
USE [final_capstone]
GO
/****** Object:  Table [dbo].[addresses]    Script Date: 8/13/2023 1:32:04 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[attributes]    Script Date: 8/13/2023 1:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[environments]    Script Date: 8/13/2023 1:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[pets]    Script Date: 8/13/2023 1:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[photos]    Script Date: 8/13/2023 1:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tags]    Script Date: 8/13/2023 1:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[users]    Script Date: 8/13/2023 1:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
CREATE TABLE [user_adopter] (
    pet_id INT NOT NULL,
    adopter_id INT NOT NULL,
	CONSTRAINT [PK_user_adopter] PRIMARY KEY (pet_id, adopter_id),
    CONSTRAINT [FK_user_adopter_user] FOREIGN KEY (pet_id) REFERENCES [pets] (pet_id),
    CONSTRAINT [FK_user_adopter_pets] FOREIGN KEY (adopter_id) REFERENCES [users] (user_id)
);
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ_UserName]    Script Date: 8/13/2023 1:32:04 PM ******/
...
GO
ALTER TABLE [dbo].[pets]  WITH CHECK ADD  CONSTRAINT [FK_pets_users1] FOREIGN KEY([adopter_id])
REFERENCES [dbo].[users] ([user_id])
GO
ALTER TABLE [dbo].[pets] CHECK CONSTRAINT [FK_pets_users1]
GO
