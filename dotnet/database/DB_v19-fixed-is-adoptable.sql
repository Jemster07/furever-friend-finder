...
GO
/****** Object:  Database [final_capstone]    Script Date: 8/17/2023 11:40:10 AM ******/
...
USE [final_capstone]
GO
/****** Object:  Table [dbo].[addresses]    Script Date: 8/17/2023 11:40:11 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[attributes]    Script Date: 8/17/2023 11:40:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[environments]    Script Date: 8/17/2023 11:40:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[pets]    Script Date: 8/17/2023 11:40:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[photos]    Script Date: 8/17/2023 11:40:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tags]    Script Date: 8/17/2023 11:40:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[user_adopter]    Script Date: 8/17/2023 11:40:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[users]    Script Date: 8/17/2023 11:40:11 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[attributes] ([attribute_id], [spayed_neutered], [house_trained], [declawed], [special_needs], [shots_current]) VALUES (6, 1, 1, 0, 0, 0)
GO
INSERT [dbo].[attributes] ([attribute_id], [spayed_neutered], [house_trained], [declawed], [special_needs], [shots_current]) VALUES (7, 1, 1, 0, 0, 0)
GO
...
GO
INSERT [dbo].[environments] ([environment_id], [children], [dogs], [cats], [other_animals], [indoor_only]) VALUES (6, 0, 0, 0, 1, 1)
GO
INSERT [dbo].[environments] ([environment_id], [children], [dogs], [cats], [other_animals], [indoor_only]) VALUES (7, 1, 0, 1, 0, 1)
GO
...
GO
INSERT [dbo].[pets] ([pet_id], [type], [species], [color], [age], [attribute_id], [environment_id], [tag_id], [name], [description], [user_id], [is_adopted], [address_id]) VALUES (8, N'cat', N'shorthairedtabby', N'white and brown', N'senior', 6, 6, 6, N'Miika', N'Miika is adorable', 7, 1, 7)
GO
INSERT [dbo].[pets] ([pet_id], [type], [species], [color], [age], [attribute_id], [environment_id], [tag_id], [name], [description], [user_id], [is_adopted], [address_id]) VALUES (9, N'cat', N'americanshorthaired', N'white and brown', N'senior', 7, 7, 7, N'Clyde', N'Clyde is a lovely big boy', 7, 1, 7)
GO
...
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (52, N'.\Pet_Photos\IMG_0604.HEIC', 8, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (53, N'.\Pet_Photos\IMG_4868.HEIC', 8, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (59, N'.\Pet_Photos\IMG_0417.jpeg', 8, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (62, N'.\Pet_Photos\IMG_1624.HEIC', 9, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (63, N'.\Pet_Photos\IMG_5007.HEIC', 9, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (64, N'.\Pet_Photos\IMG_1138.jpeg', 9, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (65, N'.\Pet_Photos\IMG_1170.jpeg', 9, 0)
GO
...
GO
INSERT [dbo].[tags] ([tag_id], [playful], [needs_exercise], [cute], [affectionate], [large], [intelligent], [happy], [short_haired], [shedder], [shy], [faithful], [leash_trained], [hypoallergenic]) VALUES (6, 0, 0, 1, 1, 0, 0, 1, 1, 1, 0, 1, 0, 0)
GO
INSERT [dbo].[tags] ([tag_id], [playful], [needs_exercise], [cute], [affectionate], [large], [intelligent], [happy], [short_haired], [shedder], [shy], [faithful], [leash_trained], [hypoallergenic]) VALUES (7, 1, 1, 1, 1, 1, 0, 1, 1, 1, 1, 1, 0, 0)
GO
...
GO
INSERT [dbo].[user_adopter] ([pet_id], [adopter_id]) VALUES (8, 7)
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ_UserName]    Script Date: 8/17/2023 11:40:11 AM ******/
ALTER TABLE [dbo].[users] ADD  CONSTRAINT [UQ_UserName] UNIQUE NONCLUSTERED 
(
	[username] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
ALTER TABLE [dbo].[pets] ADD  CONSTRAINT [DF_pets_is_adopted]  DEFAULT ((1)) FOR [is_adopted]
GO
