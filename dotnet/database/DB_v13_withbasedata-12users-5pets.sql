...
GO
/****** Object:  Database [final_capstone]    Script Date: 8/14/2023 2:57:53 PM ******/
...
USE [final_capstone]
GO
/****** Object:  Table [dbo].[addresses]    Script Date: 8/14/2023 2:57:53 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[attributes]    Script Date: 8/14/2023 2:57:53 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[environments]    Script Date: 8/14/2023 2:57:53 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[pets]    Script Date: 8/14/2023 2:57:53 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[photos]    Script Date: 8/14/2023 2:57:53 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tags]    Script Date: 8/14/2023 2:57:53 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[user_adopter]    Script Date: 8/14/2023 2:57:53 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[users]    Script Date: 8/14/2023 2:57:53 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[pets] ([pet_id], [type], [species], [color], [age], [attribute_id], [environment_id], [tag_id], [name], [description], [user_id], [is_adopted], [address_id]) VALUES (2, N'dog', N'dog', N'brindle', 6, 2, 2, 2, N'Penny', N'Penny is a lovable baby who needs to give kisses.', 3, 1, 3)
GO
INSERT [dbo].[pets] ([pet_id], [type], [species], [color], [age], [attribute_id], [environment_id], [tag_id], [name], [description], [user_id], [is_adopted], [address_id]) VALUES (4, N'cat', N'cat', N'white and grey', 3, 3, 3, 3, N'Mookie', N'Mookie is a sweet boy who loves to be held and snuggle.', 4, 0, 4)
GO
INSERT [dbo].[pets] ([pet_id], [type], [species], [color], [age], [attribute_id], [environment_id], [tag_id], [name], [description], [user_id], [is_adopted], [address_id]) VALUES (5, N'cat', N'cat', N'orange white', 3, 4, 4, 4, N'Fry', N'Fry is a shy boy and a little afraid of boys.', 9, 1, 9)
GO
INSERT [dbo].[pets] ([pet_id], [type], [species], [color], [age], [attribute_id], [environment_id], [tag_id], [name], [description], [user_id], [is_adopted], [address_id]) VALUES (7, N'dog', N'dog', N'black and tan', 6, 5, 5, 5, N'Willow', N'Willow is a sweet boy who is very affectionate and loyal.', 7, 1, 7)
GO
SET IDENTITY_INSERT [dbo].[pets] OFF
GO
SET IDENTITY_INSERT [dbo].[photos] ON 
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (1, N'.\dotnet\Pet_Photos\68753928505__B14FCDAA-35DF-4659-BA39-665B7CF96A00.HEIC', 1, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (3, N'.\dotnet\Pet_Photos\69954350736__711BDD4D-37E5-44B0-A912-F564F0A347A3.HEIC', 1, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (4, N'.\dotnet\Pet_Photos\IMG_0892.HEIC', 1, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (5, N'.\dotnet\Pet_Photos\IMG_1069.HEIC', 1, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (6, N'.\dotnet\Pet_Photos\IMG_1195.HEIC', 1, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (7, N'.\dotnet\Pet_Photos\IMG_1390.HEIC', 1, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (8, N'.\dotnet\Pet_Photos\IMG_1392.HEIC', 1, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (9, N'.\dotnet\Pet_Photos\IMG_1575.HEIC', 1, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (10, N'.\dotnet\Pet_Photos\IMG_1654.HEIC', 1, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (11, N'.\dotnet\Pet_Photos\IMG_2757.HEIC', 1, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (12, N'.\dotnet\Pet_Photos\IMG_2781.JPG', 1, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (13, N'.\dotnet\Pet_Photos\IMG_7535.HEIC', 1, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (15, N'.\dotnet\Pet_Photos\20151222_160054.jpg', 2, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (16, N'.\dotnet\Pet_photos\20160522_181208_HDR.jpg', 2, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (17, N'.\dotnet\Pet_Photos\IMG_1434.HEIC', 2, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (18, N'.\dotnet\Pet_photos\IMG_2840.HEIC', 2, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (19, N'.\dotnet\Pet_Photos\IMG_3464.HEIC', 2, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (20, N'.\dotnet\Pet_Photos\IMG_4350.JPG', 2, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (21, N'.\dotnet\Pet_Photos\IMG_4386.PNG', 2, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (22, N'.\dotnet\Pet_Photos\IMG_4604.HEIC', 2, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (23, N'.\dotnet\Pet_Photos\IMG_6549.HEIC', 2, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (25, N'.\dotnet\PetI_Photos\MG_2708.PNG', 5, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (26, N'.\dotnet\Pet_Photos\IMG_2869.HEIC', 5, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (27, N'.\dotnet\Pet_Photos\IMG_6656.heic', 5, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (28, N'.\dotnet\Pet_Photos\IMG_6790.heic', 5, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (29, N'.\dotnet\Pet_Photos\IMG_7145.heic', 5, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (30, N'.\dotnet\Pet_Photos\IMG_7267.HEIC', 5, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (31, N'.\dotnet\Pet_Photos\IMG_7269.HEIC', 5, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (32, N'.\dotnet\Pet_Photos\20170912_234106_HDR.jpg', 4, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (44, N'.\dotnet\Pet_Phtotos\IMG_0477.jpg', 4, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (45, N'.\dotnet\Pet_Photos\IMG_5016.HEIC', 4, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (46, N'.\dotnet\Pet_Photos\IMG_5020.HEIC', 4, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (47, N'.\dotnet\Pet_Phtotos\20201128_192631648_iOS.heic', 7, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (48, N'.\dotnet\Pet_Photos\20201128_203519847_iOS.heic', 7, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (50, N'.\dotnet\Pet_Photos\IMG_4935.HEIC', 7, 0)
GO
INSERT [dbo].[photos] ([photo_id], [photo_url], [pet_id], [is_not_active]) VALUES (51, N'.\dotnet\Pet_Photos\IMG_3283.jpeg', 7, 0)
GO
...
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [app_status], [is_not_active], [address_id], [email], [is_adopter]) VALUES (1, N'dunkster', N'2D0yxDbdmAbayziLKwiIegjvR08=', N'dj5a1cVHSps=', N'user', N'approved', 0, 1, N'clanduncan4@msn.com', 1)
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [app_status], [is_not_active], [address_id], [email], [is_adopter]) VALUES (2, N'someone', N'B8jyL4bA1xNM2q4O192za6vjdw0=', N'eux6J8I6yDw=', N'user', N'approved', 0, 2, N'someone@something.com', 0)
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [app_status], [is_not_active], [address_id], [email], [is_adopter]) VALUES (3, N'josieD', N'eQd3eCPcCxii1Njr4YEQcKEZ13Q=', N'qYtvtzLJdyE=', N'user', N'approved', 0, 3, N'jd@something.com', 0)
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [app_status], [is_not_active], [address_id], [email], [is_adopter]) VALUES (4, N'John', N'xjIV8dNoq3ZtyG1jk57bfmSTEsk=', N'7ptpa48lgmI=', N'user', N'approved', 0, 4, N'john@something.com', 0)
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [app_status], [is_not_active], [address_id], [email], [is_adopter]) VALUES (5, N'susie', N'uN/eYvLd8e9f69oN+N/Uxh9O6I8=', N'406yYXmyZ/o=', N'user', N'pending', 0, 5, N'susieq@something.com', 0)
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [app_status], [is_not_active], [address_id], [email], [is_adopter]) VALUES (6, N'admin', N'14fj4BCQo5Xg5GLwOJnpi5Y96UU=', N'XBD/7ydYPfg=', N'user', N'approved', 0, 6, N'admin@fureverfriends.com', 1)
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [app_status], [is_not_active], [address_id], [email], [is_adopter]) VALUES (7, N'Emelie', N'iH2TV2rgUcg6n7GqGZjvePa/tBw=', N'SLCCRCsNSS4=', N'user', N'approved', 0, 7, N'emelie@something.com', 0)
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [app_status], [is_not_active], [address_id], [email], [is_adopter]) VALUES (8, N'ralph', N'U7dJxvKfyNoewx+j6zrBa2+KT/g=', N'BVZqHeVlpNQ=', N'user', N'rejected', 0, 8, N'upcheck@something.com', NULL)
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [app_status], [is_not_active], [address_id], [email], [is_adopter]) VALUES (9, N'Riley', N'+M+eVjAiMikbA0Ee+IYiMWhqSXI=', N'8pyTcI32z7E=', N'user', N'approved', 0, 9, N'batman@something.com', 0)
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [app_status], [is_not_active], [address_id], [email], [is_adopter]) VALUES (10, N'nogo', N'UFbHQ7umAMskO7pKZLmMuOaFAT4=', N'5LICcklpGKY=', N'user', N'approved', 1, 10, N'nogo@something.com', NULL)
GO
INSERT [dbo].[users] ([user_id], [username], [password_hash], [salt], [user_role], [app_status], [is_not_active], [address_id], [email], [is_adopter]) VALUES (11, N'Joeadopter', N'oK7/44n67tnG8bBAH6bbD9MIsNs=', N'5cDGq1X3ltc=', N'user', N'approved', 0, 11, N'joeadopter@something.com', 1)
GO
SET IDENTITY_INSERT [dbo].[users] OFF
GO
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ_UserName]    Script Date: 8/14/2023 2:57:54 PM ******/
